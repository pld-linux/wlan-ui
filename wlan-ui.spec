...
wlan-ui.pl to program do łączenia się z sieciami bezprzewodowymi. Może
być uruchamiany jako graficzny interfejs użytkownika oferujący listę
dostępnych sieci do połączenia się z nimi.
